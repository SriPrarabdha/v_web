      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/track" className="hover:text-gray-300">Track Your Order</a></li>
              <li><a href="/suggest" className="hover:text-gray-300">Suggest a Gift</a></li>
              <li><a href="/vendor" className="hover:text-gray-300">Become Our Vendor</a></li>
              <li><a href="/contact" className="hover:text-gray-300">Contact Us</a></li>
              <li><a href="/bulk" className="hover:text-gray-300">Bulk Gifting</a></li>
              <li><a href="/partners" className="hover:text-gray-300">Coupon Partners</a></li>
              ...
              <li><a href="/discount" className="hover:text-gray-300">Discount Codes</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="mb-4">Get unique, Hatke gift ideas and latest offers delivered to your inbox</p>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <p>Call Us: +91-9910644899</p>
              <p>(9:00AM - 9:00PM)</p>
              <p>Email Us at: cx@myMelodiousMemories.com</p>
              
              <div className="mt-6">
                <h4 className="font-medium mb-3">FOLLOW US</h4>
                <div className="grid grid-cols-5 gap-4">
                  <a href="#" className="bg-zinc-700 p-2 hover:bg-zinc-600">
